...
# TODO: Should find the correct word ... 
def calcXY(selected_classes, x_list, y_list):
...
if shrink_data:
    ...
    x_train, y_train = calcXY(selected_classes, x_train, y_train)
    print(x_train.shape, y_train.shape)
    
    print('test\n', x_test.shape, y_test.shape)
    x_test, y_test = calcXY(selected_classes, x_test, y_test)
